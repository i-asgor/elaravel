...
Route::group(['middleware' => ['frontlogin']],function(){
    //Route for users Account Information
    Route::match(['get','post'],'/account','UsersController@account');
    //Route for users password change
    Route::match(['get','post'],'/change-password','UsersController@changePassword');
    //Route for Address change
...
Route::group(['middleware' => ['AdminLogin']],function(){
    ...
    Route::post('/admin/update-banners-status', 'BannersController@updateStatus');

    //Coupons Route
    Route::match(['get', 'post'], '/admin/add-coupon', 'CouponsController@addCoupon');
    Route::match(['get', 'post'], '/admin/view-coupons', 'CouponsController@viewCoupons');
    Route::match(['get', 'post'], '/admin/edit-coupon/{id}', 'CouponsController@editCoupons');
