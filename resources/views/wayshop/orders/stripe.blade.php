        ...
        <div class="row">
            <div class="col-lg-6">
                <div align="center">
                    ...
                    <p>Your Order Number is {{Session::get('order_id')}} and total payable about is  {{Session::get('grand_total')}} TK</p>
...
var stripe = Stripe('pk_test_51Ht610Hg6ZxPv4yuxNZYN3mC3f04qAUJWIwyeEVfrLmBXUhb0fpl4E6FPRo5Wlir33OM7JWDZKz5v2FSIHyVk8Iw00pI5A5jau');
